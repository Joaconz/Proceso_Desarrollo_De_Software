                            ...
                            <div className="mt-4 pt-4 border-t border-border">
                                <div className="flex items-center justify-between text-sm">
                                    ...
                                    <span className="font-semibold text-white">
                                        {match.jugadoresEnlistados?.length || 0} / {match.cantidadJugadoresReq}
                                    </span>
                                </div>
                                {/* Visual Progress Bar */}
                                <div className="w-full h-2 bg-[#27272a] rounded-full mt-2 overflow-hidden">
                                    <div
                                        ...
                                        style={{ width: `${Math.min(100, ((match.jugadoresEnlistados?.length || 0) / match.cantidadJugadoresReq) * 100)}%` }}
                                    />
                                </div>
                            </div>
                        </CardContent>
